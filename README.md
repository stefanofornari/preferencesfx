...
`.crumbsVisibility` | `PreferencesFx` | Sets the visibility of the breadcrumb bar at the top of the preferences dialog. The breadcrumb bar shows the navigation path through the categories hierarchy. Defaults to true.
